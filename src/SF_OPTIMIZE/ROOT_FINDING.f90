MODULE OPTIMIZE_ROOT_FINDING
  ...
  interface fsolve
     module procedure :: fsolve_sub_interface
     module procedure :: fsolve_func_interface
...
contains
  ...
  !MULTI-DIMENSIONAL:
  !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  subroutine fsolve_sub_interface(func,x,tol,info)
    interface
  ...
  end subroutine fsolve_sub_interface


  subroutine fsolve_func_interface(ff,x,tol,info)
    ...
    call hybrd1(func,n,x,fvec,tol_,info_)
    if(present(info))info=info_
  end subroutine fsolve_func_interface
  !
  subroutine func(n,x,fvec,iflag)
    integer ::  n
    real(8) ::  x(n)
...
END MODULE OPTIMIZE_ROOT_FINDING
