...
!PURPOSE  : 
!+-------------------------------------------------------------------+
function dv_check_convergence(Xnew,eps,N1,N2,id) result(convergence)
  integer,optional         :: id
  integer                  :: id_
  integer                  :: i,Msize
  logical                  :: convergence  
...
function zv_check_convergence(Xnew,eps,N1,N2,id) result(convergence)
  integer,optional            :: id
  integer                     :: id_
  integer                     :: i,Msize
  logical                     :: convergence  
...
function dm_check_convergence(Xnew,eps,N1,N2,id,tight) result(convergence)
  integer,optional         :: id
  integer                  :: id_
...
function zm_check_convergence(Xnew,eps,N1,N2,id,tight) result(convergence)
  integer,optional            :: id
  integer                     :: id_
  integer                     :: i,j,Msize1,Msize2
  logical,optional            :: tight
