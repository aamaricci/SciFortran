program testSLPLOTeREAD
  ...
  print*,"             STORE <--> READ                   "
  print*,""
  call store_data("A1.dat",A1)
  call read_data("A1.dat",A1_)
  print*,"A1:",sum(A1-A1_)
  call store_data("B1.dat",B1)
  call read_data("B1.dat",B1_)
  print*,"B1:",sum(B1-B1_)

  call store_data("A2.dat",A2)
  call read_data("A2.dat",A2_)
  print*,"A2:",sum(A2-A2_)
  call store_data("B2.dat",B2)
  call read_data("B2.dat",B2_)
  print*,"B2:",sum(B2-B2_)

  call store_data("A3.dat",A3)
  call read_data("A3.dat",A3_)
  print*,"A3:",sum(A3-A3_)
  call store_data("B3.dat",B3)
  call read_data("B3.dat",B3_)
  print*,"B3:",sum(B3-B3_)

  call store_data("A4.dat",A4)
  call read_data("A4.dat",A4_)
  print*,"A4:",sum(A4-A4_)
  call store_data("B4.dat",B4)
  call read_data("B4.dat",B4_)
  print*,"B4:",sum(B4-B4_)

  call store_data("A5.dat",A5)
  call read_data("A5.dat",A5_)
  print*,"A5:",sum(A5-A5_)
  call store_data("B5.dat",B5)
  call read_data("B5.dat",B5_)
  print*,"B5:",sum(B5-B5_)

  call store_data("A6.dat",A6)
  call read_data("A6.dat",A6_)
  print*,"A6:",sum(A6-A6_)
  call store_data("B6.dat",B6)
  call read_data("B6.dat",B6_)
  print*,"B6:",sum(B6-B6_)

  call store_data("A7.dat",A7)
  call read_data("A7.dat",A7_)
  print*,"A7:",sum(A7-A7_)
  call store_data("B7.dat",B7)
  call read_data("B7.dat",B7_)
  print*,"B7:",sum(B7-B7_)
