...
contains
  ...
  !
  !=============================================================================
  include 'quadpack_aux.f90'

end MODULE INTEGRATE_QUADPACK
