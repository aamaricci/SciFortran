  ...
  contains
    ...
    function square_lattice_dispersion(ka,ts,tsp)
      ...
      if(t_hopping==0.d0)then
         print*,"#######WARNING#######"
         print*,"error suspect in +square_lattice_velocity: t_hopping=0!"
         call sleep(1)
      endif
    ...
    function square_lattice_velocity(kt,ts,tsp)
      type(vect2D),intent(in) :: kt
      real(8),optional        :: ts,tsp
      type(vect2D)            :: velocity,square_lattice_velocity
      if(present(ts))t_hopping=ts
      if(present(tsp))t_prime=tsp
      if(t_hopping==0.d0)then
         print*,"#######WARNING#######"
      ...
      square_lattice_velocity=velocity
    ...
    !+-----------------------------------------------------------------+
    subroutine square_lattice_structure(wt,Nx,Ny)
      real(8),dimension(:) :: wt
      integer              :: Nx
      integer,optional     :: Ny
      integer              :: ik,ir,ix,iy,Nk,Lk,Lk_
      real(8)              :: peso 
      real(8)              :: Kx,Ky,Rx,Ry
    ...
    end subroutine square_lattice_structure
    ...
    !+-----------------------------------------------------------------+
    subroutine square_lattice_dispersion_array(epsik,ts,tsp,sorted_epsik,sorted_ik)
      ...
      Lk=size(epsik)                           !Number of K-points stored in epsik    
    ...
    end subroutine square_lattice_dispersion_array
