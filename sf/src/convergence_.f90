...
!PURPOSE  : 
!+-------------------------------------------------------------------+
function dv_check_convergence_local(Xnew,eps,N1,N2,id,index,total) result(convergence)
...
function zv_check_convergence_local(Xnew,eps,N1,N2,id,index,total) result(convergence)
  integer,optional         :: id,index,total
  integer                  :: id_,index_,total_
  integer                     :: i,Msize
  logical                     :: convergence  
...
function dm_check_convergence_local(Xnew,eps,N1,N2,id,index,total,tight) result(convergence)
  integer,optional         :: id,index,total
  integer                  :: id_,index_,total_
...
function zm_check_convergence_local(Xnew,eps,N1,N2,id,index,total,tight) result(convergence)
  integer,optional         :: id,index,total
  integer                  :: id_,index_,total_
  integer                     :: i,j,Msize1,Msize2
  logical,optional            :: tight
