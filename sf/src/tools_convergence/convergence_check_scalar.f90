...
!PURPOSE  : 
!+-------------------------------------------------------------------+
function i0_check_convergence_scalar(Xnew,eps,N1,N2,id,index,total) result(convergence)
...
function d0_check_convergence_scalar(Xnew,eps,N1,N2,id,index,total) result(convergence)
...
function z0_check_convergence_scalar(Xnew,eps,N1,N2,id,index,total) result(convergence)
