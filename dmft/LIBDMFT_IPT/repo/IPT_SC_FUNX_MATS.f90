...
contains
  ...
  !COMMENT  : 
  !+-------------------------------------------------------------------+
  function solve_ipt_sc_matsubara(fg0_,fg_,delta_,label_,iprint_) result(sigma_)
  ...
  subroutine simpurity
    !complex(8),dimension(L) :: det
    !det       =  abs(fg0(1)%iw**2) + fg0(2)%iw**2
